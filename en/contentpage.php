  ...
  <div class="page">
    ...
    <nav class="mobilenav">
      <ul class="nobulls">
        ...
        <li class="mlang"><a href="<?php echo"../th/contentpage.php?ID=$call_arti";?>" class="mlang">TH</a></li>
      </ul>
    </nav>
    ...
    <nav class="meta">
      <ul class="nobulls">
        ...
        <li><a href="<?php echo"../th/contentpage.php?ID=$call_arti";?>" class="last">Thai</a></li>
