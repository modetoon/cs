  ...
  <div class="page">
    ...
    <nav class="mobilenav">
      <ul class="nobulls">
        ...
        <li class="mlang"><a href="<?php echo"../th/jobs_content.php";?>" class="mlang">TH</a></li>
      </ul>
    </nav>
      ...
      <div role="main" class="main">
        <div class="service">
          <ul class="breadcrumb">
            <li><a href="index.php">Home</a></li>
				<?php include"top_sup_menu_jobs.php";	?>
          </ul>
        ...
        <!--Slider Start-->
            ...
            <nav id="lefthand" class="unit size-col-a lfthnd">
              <ul class="lfthndnavi">
                <?php include "left_menu_jobs.php";	?>
              </ul>
            </nav>
            ...
            <div class="unit size-col-d">
              <div class="topline">Options for your personal development</div>
              <h1>Working with Bayer Thai</h1>
<?php
			...
			<table class='table txtR'>
                ...
                <tbody>
                  <tr>
                    <th class='txtL' colspan='2'>Lists of all jobs</th>
                  </tr>
                  <tr class='borderblue'>
                    <td>Date</td>
                    <td class='em'><center>Job Title</center></td>
                  </tr>";
		...
		?>
            ...
            <aside class="unit size-col-a margi">
              ...
              <div class="margiblock">
                ...
                <hr>
                <div class="mlnk"><li>Interested applicants are invited to apply by sending your CV to<a href="mailto:hr-recruitment@bayer.com">hr-recruitment@bayer.com</a> or contract Recruitment 02-232-7007</li></div>
              </div>
              
              <div class="margiblock">
                <h1 class="h5">VDO center</h1>
                <hr>
    ...
    <nav class="meta">
      <ul class="nobulls">
        ...
        <li><a href="<?php echo"../th/jobs_content.php";?>" class="last">Thai</a></li>
