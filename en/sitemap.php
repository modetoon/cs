  ...
  <div class="page">
    ...
    <nav class="mobilenav">
      <ul class="nobulls">
        ...
        <li class="mlang"><a href="../th/sitemap.php" class="mlang">TH</a></li>
      </ul>
    </nav>
...
<h1>Sitemap</h1>
  ...
  <?php
	...
	while($rs=mysql_fetch_array($result)) {
			...
			$sql14="select id_menu from tb_menu WHERE sub_of='$s1_id_menu' AND name_menu='Overview';";
...
?>   
    ...
    <nav class="meta">
      <ul class="nobulls">
        ...
        <li><a href="../th/sitemap.php" class="last">Thai</a></li>
