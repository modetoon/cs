window.Modernizr = function(e, t, n) {
        ...
        d = i(F, "undefined") || i(F.call, "undefined") ? function(e, t) {
            ...
            var n;
            return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : D(["@media (", w.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
                n = 9 === e.offsetTop
            }), n
            ...
            return r((e + "-webkit- ".split(" ").join(t + e) + w.join(n + e)).slice(0, -e.length)), a(b.backgroundImage, "gradient")
            ...
            var e;
            return D(["#", v, "{font:0/0 a}#", v, ':after{content:"', x, '";visibility:hidden;font:3px/1 a}'].join(""), function(t) {
                e = t.offsetHeight >= 3
            }), e
        }, N.video = function() {
            ...
            return !!t.createElementNS && /SVGAnimate/.test(S.call(t.createElementNS(j.svg, "animate")))
        }, N.svgclippaths = function() {
            return !!t.createElementNS && /SVGClipPath/.test(S.call(t.createElementNS(j.svg, "clipPath")))
        };
        for (var O in N) d(N, O) && (f = O.toLowerCase(), m[f] = N[O](), $.push((m[f] ? "" : "no-") + f));
        return m.input || l(), m.addTest = function(e, t) {
            ...
            return m
        }, r(""), y = E = null, m._version = p, m._prefixes = w, m._domPrefixes = k, m._cssomPrefixes = T, m.mq = L, m.hasEvent = z, m.testProp = function(e) {
            return c([e])
        }, m.testAllProps = u, m.testStyles = D, m.prefixed = function(e, t, n) {
            return t ? u(e, t, n) : u(e, "pfx")
        }, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (h ? " js " + $.join(" ") : ""), m
    }(this, this.document),
    function(e, t) {
        function n(e, t) {
        ...
        function s(e) {
            e || (e = t);
            var r = o(e);
            return w.shivCSS && !m && !r.hasCSS && (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), h || c(e, r), e
        }
        ...
        function p(e) {
            ...
            var r, i, a = o(e),
                c = e.namespaces,
                s = e.parentWindow;
            return !k || e.printShived ? e : ("undefined" == typeof c[T] && c.add(T), s.attachEvent("onbeforeprint", function() {
                t();
                for (var o, a, c, s = e.styleSheets, l = [], d = s.length, p = Array(d); d--;) p[d] = s[d];
                for (; c = p.pop();)
        ...
        w.type += " print", w.shivPrint = p, p(t)
    }(this, document),
    function(e, t, n) {
        function r(e) {
        ...
        function s(e, n, r, o, i, s, u) {
            ...
            1 === k[n] && (g = 1, k[n] = []), "object" == e ? f.data = n : (f.src = n, f.type = e), f.width = f.height = "0", f.onerror = f.onload = f.onreadystatechange = function() {
                l.call(this, g)
            }, v.splice(o, 0, b), "img" != e && (g || 2 === k[n] ? (x.insertBefore(f, E ? null : h), m(l, u)) : k[n].push(f))
        }

        function u(e, t, n, r, i) {
            return y = 0, t = t || "j", o(e) ? s("c" == t ? w : S, e, t, this.i++, n, r, i) : (v.splice(this.i++, 0, e), 1 == v.length && c()), this
        }
        ...
        d = function(e) {
            ...
            function a(e, o, i, a, c) {
                var s = t(e),
                    u = s.autoCallback;
                s.url.split(".").pop().split("?").shift(), s.bypass || (o && (o = r(o) ? o : o[e] || o[a] || o[e.split("/").pop().split("?")[0]]), s.instead ? s.instead(e, o, i, a, c) : (k[s.url] ? s.noexec = !0 : k[s.url] = 1, i.load(s.url, s.forceCSS || !s.forceJS && "css" == s.url.split(".").pop().split("?").shift() ? "c" : n, s.noexec, s.attrs, s.timeout), (r(o) || r(u)) && i.load(function() {
                    l(), o && o(s.origUrl, c, a), u && u(s.origUrl, c, a), k[s.url] = 2
                })))
            }
