...
$(document).ready(function() {
    ...
    gm_label[0].all_org = 'Bereich: Alle';
    gm_label[1].all_org = 'Area: All';
    ...
    /*Lang <> Url*/
    gm_url[0].org = '//shared.bayer.com/json/contacts_new_de.json';
    gm_url[1].org = '//shared.bayer.com/json/contacts_new_en.json';
    gm_url[0].wsearch = '//shared.bayer.com/module/websitesearchform/rest/lang_de/';
    gm_url[1].wsearch = '//shared.bayer.com/module/websitesearchform/rest/lang_en/';
    gm_url[0].wresult = '//shared.bayer.com/module/websitesearchresult/rest/lang_de/';
    ...
    /* GLOBAL META - ROOT*/
    gm_html_content[0].worldwide = '<div id="worldwide" class="loadedhtml"><ul class="nobulls"><li><a href="http://www.bayer.de">Bayer Global</a></li><li><a class="showpanel sp01" href="#">Tätigkeitsfelder</a></li><li><a class="showpanel sp02" href="#">Standorte</a></li><li><a class="showpanel sp03" href="#">Websites</a></li></ul></div>';
    gm_html_content[1].worldwide = '<div id="worldwide" class="loadedhtml"><ul class="nobulls"><li><a href="http://www.bayer.com">Bayer Global</a></li><li><a class="showpanel sp01"href="#">Our Businesses</a></li><li><a class="showpanel sp02" href="#">Locations</a></li><li><a class="showpanel sp03" href="#">Websites</a></li></ul></div>';

    /* GLOBAL META -PANEL 1*/
    gm_html_content[0].panel1 = '<div class="line"><div class="unit size3metarows"><div class="line"><div class="unit size1of4"><h2 class="business-head">Pharmaceuticals</h2><div class="img"><a href="http://pharma.bayer.com"><img src="' + gm_url[0].images + 'ph.png" width="180" height="80" data-original="' + gm_url[0].images + 'pharmaceuticals.jpg" alt="" class="lazy" /></a></div><p>Pharmaceuticals konzentriert sich auf verschreibungspflichtige Produkte auf den Gebieten Kardiologie, Frauengesundheit, Onkologie, Hämatologie & Ophthalmologie.</p><p><a class="ghst-btn block-btn" href="http://pharma.bayer.com">Globale Website</a></p></div>';
    gm_html_content[0].panel1 += '<div class="unit size1of4"><h2 class="business-head">Consumer Health</h2><div class="img"><a href="http://consumerhealth.bayer.com"><img src="' + gm_url[0].images + 'ph.png" width="180" height="80" data-original="' + gm_url[0].images + 'consumer-health.jpg" alt="" class="lazy" /></a></div><p>Consumer Health vertreibt einige der weltweit bekanntesten rezeptfreien Arzneimittel, Nahrungsergänzungs-Präparate sowie weitere Selbstmedikations-Produkte.</p><p><a class="ghst-btn block-btn" href="http://consumerhealth.bayer.com">Globale Website</a></p></div>';
    gm_html_content[0].panel1 += '<div class="unit size1of4"><h2 class="business-head">Crop Science</h2><div class="img"><a href="http://www.cropscience.bayer.com"><img src="' + gm_url[0].images + 'ph.png" width="180" height="80" data-original="' + gm_url[0].images + 'crop-science.jpg" alt="" class="lazy" /></a></div><p>Crop Science ist auf den Gebieten Saatgut, Pflanzenschutz und Schädlingsbekämpfung außerhalb der Landwirtschaft tätig.</p><p><a class="ghst-btn block-btn" href="http://www.cropscience.bayer.com">Globale Website</a></p></div>';
    gm_html_content[0].panel1 += '<div class="unit size1of4 lastUnit"><h2 class="business-head">Animal Health</h2><div class="img"><a href="http://tiergesundheit.bayer.de" target="_blank"><img src="' + gm_url[0].images + 'ph.png" width="180" height="80" data-original="' + gm_url[0].images + 'animal-health.jpg" alt="" class="lazy" /></a></div><p>Animal Health engagiert sich mit innovativen Therapien & Lösungen für die Gesundheit von Tieren und unterstützt so Tierärzte, Landwirte & Tierhalter.</p><p><a class="ghst-btn block-btn" href="http://tiergesundheit.bayer.de" target="_blank">Globale Website</a></p></div>';
    gm_html_content[0].panel1 += '</div></div><div class="unit size-vl"><div style="height:283px; border-left:1px solid #dcdcdc; margin:0 10px 0 9px;"></div></div><div class="unit size-col-a panelmargi lastUnit"><h1 class="h5">Organisation</h1><p class="lnk pht"><a href="http://www.bayer.de/de/profil-und-organisation.aspx">Profil und Organisation</a><a href="http://www.bayer.de/bayer-organisationsstruktur" target="_blank">Organigramm (PDF,&nbsp;174&nbsp;KB)</a><br /><a href="http://business-services.bayer.de">Bayer Business Services</a><br /><a href="http://www.covestro.de/">Covestro</a></p></div></div>';

    gm_html_content[1].panel1 = '<div class="line"><div class="unit size3metarows"><div class="line"><div class="unit size1of4"><h2 class="business-head">Pharmaceuticals</h2><div class="img"><a href="http://pharma.bayer.com"><img src="' + gm_url[1].images + 'ph.png" width="180" height="80" data-original="' + gm_url[1].images + 'pharmaceuticals.jpg" alt="" class="lazy" /></a></div><p>Pharmaceuticals focuses on prescription drugs for the therapeutic areas of cardiology, oncology, gynecology, hematology & ophthalmology.</p><p><a class="ghst-btn block-btn" href="http://pharma.bayer.com">Global Site</a></p></div>';
    gm_html_content[1].panel1 += '<div class="unit size1of4"><h2 class="business-head">Consumer Health</h2><div class="img"><a href="http://consumerhealth.bayer.com"><img src="' + gm_url[1].images + 'ph.png" width="180" height="80" data-original="' + gm_url[1].images + 'consumer-health.jpg" alt="" class="lazy" /></a></div><p>Consumer Health brings consumers some of the world’s best-known and most trusted over-the-counter (OTC) medications, nutritional supplements and other self-care products.</p><p><a class="ghst-btn block-btn" href="http://consumerhealth.bayer.com">Global Site</a></p></div>';
    gm_html_content[1].panel1 += '<div class="unit size1of4"><h2 class="business-head">Crop Science</h2><div class="img"><a href="http://www.cropscience.bayer.com"><img src="' + gm_url[1].images + 'ph.png" width="180" height="80" data-original="' + gm_url[1].images + 'crop-science.jpg" alt="" class="lazy" /></a></div><p>Crop Science has businesses in seeds, crop protection and non-agricultural pest control.</p><p><a class="ghst-btn block-btn" href="http://www.cropscience.bayer.com">Global Site</a></p></div>';
    gm_html_content[1].panel1 += '<div class="unit size1of4 lastUnit"><h2 class="business-head">Animal Health</h2><div class="img"><a href="http://animalhealth.bayer.com" target="_blank"><img src="' + gm_url[1].images + 'ph.png" width="180" height="80" data-original="' + gm_url[1].images + 'animal-health.jpg" alt="" class="lazy" /></a></div><p>Animal Health is passionate about the health of animals. We support vets, farmers and pet-owners that care for them with innovative therapies and solutions.</p><p><a class="ghst-btn block-btn" href="http://animalhealth.bayer.com" target="_blank">Global Site</a></p></div>';
    gm_html_content[1].panel1 += '</div></div><div class="unit size-vl"><div style="height:283px; border-left:1px solid #dcdcdc; margin:0 10px 0 9px;"></div></div><div class="unit size-col-a panelmargi lastUnit"><h1 class="h5">Organization</h1><p class="lnk pht"><a href="http://www.bayer.com/en/profile-and-organization.aspx">Profile and Organization</a><a href="http://www.bayer.com/bayer-organizational-structure" target="_blank">Organization chart (PDF,&nbsp;174&nbsp;KB)</a><br /><a href="http://business-services.bayer.com">Bayer Business Services</a><br /><a href="http://www.covestro.com/">Covestro</a></p></div></div>';

    gm_html_content[0].panel2 = '<div style="position: absolute; z-index: 2; width: 966px; height: 330px;" class="preloader"></div><div class="unit size-col-a dd-for-mobile"><h2>Wählen Sie ein Land:</h2><hr><div class="media"><div class="scrollbox scroll-pane" ><!-- LIST START--><ul class="nobulls lnk" data-bind="foreach: countrys"><li><a data-bind="text: country, attr:{ rel: $index, href: \'#\'}, click: $root.viewit"></a><ul data-bind="foreach:subs"><li><a href="#"data-bind="text:title , click: $root.viewit2" ></a></li></ul></li></ul><!-- LIST STOP --></div></div></div><!-- MAP START --><div class="unit size575 world"><div class="scrollbox2 scroll-pane" data-bind="template: {name: \'jsonCountrys\', foreach: $root.subsDetails  }" ></div> </div><!-- MAP STOP --><!-- RIGHT START -->';
    gm_html_content[0].panel2 += '<div class="unit size-vl"><div style="height:362px; border-left:1px solid #dcdcdc; margin:0 10px 0 9px;"></div></div><div class="unit size-col-a panelmargi lastUnit"><h1 class="h5">Globale Links</h1><p class="lnk pht"><a href="http://www.bayer.de">Bayer Global</a><br><a href="http://www.news.bayer.de">Nachrichten</a><br><a href="http://www.investor.bayer.de">Investoren</a><br><a href="https://www.career.bayer.com/de/">Karriere</a><br><a href="http://www.bayer.de/de/produkte.aspx">Produkte</a><br><a href="http://www.bayer.de/de/nachhaltigkeit.aspx">Nachhaltigkeit</a></p><a class="ghst-btn" data-bind="attr: {href:$root.globalContact().email}">Kontakt</a></p><div class="spacer"></div><h1 class="h5">Folgen Sie uns</h1><ul class="nvgtn socialmedia"><li><a href="http://www.facebook.com/Bayer" data-rel="tooltip" target="_blank" class="ir fb" data-original-title="Folgen Sie uns auf Facebook">facebook</a></li><li><a href="http://twitter.com/bayer" data-rel="tooltip" target="_blank" class="ir tw" data-original-title="Folgen Sie uns auf Twitter">twitter</a></li><li><a href="http://www.youtube.com/user/BayerTV" data-rel="tooltip" target="_blank" class="ir yt" data-original-title="Folgen Sie uns auf Youtube">youtube</a></li><li><a href="http://www.linkedin.com/company/bayer" data-rel="tooltip" target="_blank" class="ir li" data-original-title="Folgen Sie uns auf LinkedIn">LinkedIn</a></li><li><a href="http://instagram.com/bayerofficial" data-rel="tooltip" target="_blank" class="ir ig" data-placement="left" data-original-title="Folgen Sie uns auf Instagram">Instagram</a></li><li><a href="/de/rss.aspx" title="RSS Feed" data-rel="tooltip" target="_blank" class="ir rss" data-placement="left">RSS</a></li></ul><div class="spacer"></div></div><!-- RIGHT STOP -->';

    gm_html_content[1].panel2 = '<div style="position: absolute; z-index: 2; width: 966px; height: 330px;" class="preloader"></div><div class="unit size-col-a dd-for-mobile"><h2>Select a country:</h2><hr><div class="media"><div class="scrollbox scroll-pane" ><!-- LIST START--><ul class="nobulls lnk" data-bind="foreach: countrys"><li><a data-bind="text: country, attr:{ rel: $index, href: \'#\'}, click: $root.viewit"></a><ul data-bind="foreach:subs"><li><a href="#"data-bind="text:title , click: $root.viewit2" ></a></li></ul></li></ul><!-- LIST STOP --></div></div></div><!-- MAP START --><div class="unit size575 world"><div class="scrollbox2 scroll-pane" data-bind="template: {name: \'jsonCountrys\', foreach: $root.subsDetails  }" ></div> </div><!-- MAP STOP --><!-- RIGHT START -->';
    gm_html_content[1].panel2 += '<div class="unit size-vl"><div style="height:362px; border-left:1px solid #dcdcdc; margin:0 10px 0 9px;"></div></div><div class="unit size-col-a panelmargi lastUnit"><h1 class="h5">Global Links</h1><p class="lnk pht"><a href="http://www.bayer.com">Bayer Global</a><br><a href="http://www.news.bayer.com">News</a><br><a href="http://www.investor.bayer.com">Investors</a><br><a href="https://www.career.bayer.com">Career</a><br><a href="http://www.bayer.com/en/products.aspx">Products</a><br><a href="http://www.bayer.com/en/sustainability.aspx">Sustainability</a></p><a class="ghst-btn" data-bind="attr: {href:$root.globalContact().email}">Contact us</a></p><div class="spacer"></div><h1 class="h5">Follow us</h1><ul class="nvgtn socialmedia"><li><a href="http://www.facebook.com/Bayer" data-rel="tooltip" target="_blank" class="ir fb" data-original-title="Follow Us on Facebook">Facebook</a></li><li><a href="http://twitter.com/bayer" title="Follow Us on Twitter" data-rel="tooltip" target="_blank" class="ir tw">Twitter</a></li><li><a href="http://www.youtube.com/user/BayerTVinternational" title="Follow Us on YouTube" data-rel="tooltip" target="_blank" class="ir yt">YouTube</a></li><li><a href="http://www.linkedin.com/company/bayer" title="Follow Us on LinkedIn" data-rel="tooltip" target="_blank" class="ir li">LinkedIn</a></li><li><a href="http://instagram.com/bayerofficial" title="Follow Us on Instagram" data-rel="tooltip" target="_blank" class="ir ig" data-placement="left">Instagram</a></li><li><a href="/en/rss.aspx" title="RSS Feed" data-rel="tooltip" target="_blank" class="ir rss" data-placement="left">RSS</a></li></ul><div class="spacer"></div></div><!-- RIGHT STOP -->';
    gm_html_content[0].panel3 = '<div style="position: absolute; z-index: 2; width: 966px; height: 410px;" class="preloader"></div><h2>Suchen Sie nach Bayer Websites weltweit</h2><hr><div class="line"><div class="unit size-col-a"><label>Region</label><select data-bind="event: { change: changed }, options: availableRegions, optionsText:\'name\', value: selectedRegion, optionsValue:\'id\', optionsCaption:regionsCount()"></select><div class="spacer-ten"></div><label>Country</label><select data-bind="event: { change: changed },options: availableCountrysFiltered, optionsText:\'name\', value: selectedCountry, optionsValue:\'id\', optionsCaption:countrysCount()"></select><div class="spacer-ten"></div></div><div class="unit size-col-a"><label>Organization</label><select data-bind="event: { change: changed },options: availableOrganizations, optionsText:\'name\', value: selectedOrganization, optionsValue:\'id\', optionsCaption:organizationsCount()"></select><div class="spacer-ten"></div><label class="right">Product websites</label><select data-bind="event: { change: changed },options: availableProductsFiltered, optionsText:\'name\', value: selectedProduct, optionsValue:\'id\', optionsCaption:productsCount()"></select><div class="spacer-ten"></div></div><div class="unit size-col-a"><label class="right">Topic &amp; field of activity</label><select data-bind="event: { change: changed },options: availableTopicsFiltered, optionsText:\'name\', value: selectedTopic, optionsValue:\'id\', optionsCaption:topicsCount()"></select><div class="spacer-ten"></div><label>Search</label><form data-bind="submit: siteSearch"><input class="nocomplete" data-bind="value: searchText, watermark: \'Ihr Suchbegriff\', valueUpdate: \'afterkeydown\'" /><!-- button class="btn submit" type="submit">Search</button --></form><div class="spacer-ten"></div></div><div style="width:108px;" class="unit"><button class="btn submit" data-bind="click: siteSearch">Suche</button></div><div class="unit size1of5 lastUnit"><div class="p">Hinweis: Alle Kategorien sind miteinander verknüpft, damit Sie mindestens ein Ergebnis für Ihre Suchanfrage erhalten. Eine Ausnahme bildet die Freitextsuche.</div></div></div><div class="spacer"></div><div class="spacer"></div><!-- Results Start --><div class="line"><h2>Suchergebnis: <span class="green" data-bind="text: websiteCount"></span><span class="green">&nbsp;Website(s) gefunden</span><!-- indicator Start--><span class="loading counter">&nbsp;</span><span class="loading resultcounter">&nbsp;</span><!-- indicator Stop --></h2><hr><!-- Results Stop --><div class="media"><div class="loading results">&nbsp;</div><div class="scroll-pane" style="height:215px;" data-bind="template: {name: \'searchResultsItem\', foreach: searchResults}"></div><!-- Results Stop --><div class="spacer-ten"></div><hr><p style="margin:0 10px">* vormals Bayer MaterialScience <a class="more" href="http://www.bayer.de/de/covestro.aspx">mehr</a></p></div></div>';
    gm_html_content[1].panel3 = '<div style="position: absolute; z-index: 2; width: 966px; height: 410px;" class="preloader"></div><h2>Search for Bayer Websites worldwide</h2><hr><div class="line"><div class="unit size-col-a"><label>Region</label><select data-bind="event: { change: changed }, options: availableRegions, optionsText:\'name\', value: selectedRegion, optionsValue:\'id\', optionsCaption:regionsCount()"></select><div class="spacer-ten"></div><label>Country</label><select data-bind="event: { change: changed },options: availableCountrysFiltered, optionsText:\'name\', value: selectedCountry, optionsValue:\'id\', optionsCaption:countrysCount()"></select><div class="spacer-ten"></div></div><div class="unit size-col-a"><label>Organization</label><select data-bind="event: { change: changed },options: availableOrganizations, optionsText:\'name\', value: selectedOrganization, optionsValue:\'id\', optionsCaption:organizationsCount()"></select><div class="spacer-ten"></div><label class="right">Product websites</label><select data-bind="event: { change: changed },options: availableProductsFiltered, optionsText:\'name\', value: selectedProduct, optionsValue:\'id\', optionsCaption:productsCount()"></select><div class="spacer-ten"></div></div><div class="unit size-col-a"><label class="right">Topic &amp; field of activity</label><select data-bind="event: { change: changed },options: availableTopicsFiltered, optionsText:\'name\', value: selectedTopic, optionsValue:\'id\', optionsCaption:topicsCount()"></select><div class="spacer-ten"></div><label>Search</label><form data-bind="submit: siteSearch"><input class="nocomplete" data-bind="value: searchText, watermark: \'Enter your search term\', valueUpdate: \'afterkeydown\'" /><!-- button class="btn submit" type="submit">Search</button --></form><div class="spacer-ten"></div></div><div style="width:108px;" class="unit"><button class="btn submit" data-bind="click: siteSearch">Search</button></div><div class="unit size1of5 lastUnit"><div class="p">Note: all the categories are linked so you will get at least one hit for any query. This does not apply to the free-text search function.</div></div></div><div class="spacer"></div><div class="spacer"></div><!-- Results Start --><div class="line"><h2>Search result: <span class="green" data-bind="text: websiteCount"></span><span class="green">&nbsp;website(s) found</span><!-- indicator Start--><span class="loading counter">&nbsp;</span><span class="loading resultcounter">&nbsp;</span><!-- indicator Stop --></h2><hr><!-- Results Stop --><div class="media"><div class="loading results">&nbsp;</div><div class="scroll-pane" style="height:215px;" data-bind="template: {name: \'searchResultsItem\', foreach: searchResults}"></div><!-- Results Stop --><div class="spacer-ten"></div><hr><p style="margin:0 10px">* formerly Bayer MaterialScience <a class="more" href="http://www.bayer.com/en/covestro.aspx">more</a></p></div></div>';
    gm_html_content[0].panel = '<div class="panel" style="display:none;"><a class="closepaneltop" href="#">schließen</a><a class="closepanel" href="#">schließen</a><span class="panelbottom"></span></div>';
    ...
    /*Global Meta Navigation JS*/
    /*remove existing dom node*/
    $('#worldwide').remove();
    /*add new dom node*/
    $('#header').after(gm_html_content[gm_lang].worldwide);
    var gm_panelheight = '420px',
        gm_lastActivePanel = '';
    //activateSearch();
    ...
    $('.showpanel').click(function(e) {
        ...
        switch (clicked) {
            case 'sp01':
                ...
                /*add dom node if not exist*/
                if ($('.p01').length < 1) {
                    $('.panel').append('<div class="p01" style="display:block;">' + gm_html_content[gm_lang].panel1 + '</div>');
                }
                gm_panelheight = '346px';
            ...
            case 'sp03':
                ...
                $('.loading.counter, .loading.resultcounter').css({
                    'display': 'none',
                    'height': '16px',
                    'margin-left': '10px',
                    'position': 'absolute',
        ...
        $("a.closepanel, a.closepaneltop").click(function(e) {
            ...
            if ($("body").hasClass("lt-768")) {
                $("a.mnav").trigger("click");
            }
            $('a.closepanel, a.closepaneltop, .dd-for-mobile h2').off('click');
        ...
        $('.dd-for-mobile h2').click(function(event) {
            $(".dd-for-mobile .media").slideToggle();
    ...
    function LocationListViewModel() {
        ...
        self.viewit2 = function(item) {
            ...
            if (typeof(this.country) === 'function') {
                ...
                self.currentCountry = {
                    countryname: this.country + ' - ' + this.title
                };
        ...
        self.getData = function() {
            ...
            $.jsonp({
                ...
                success: function(json) {
                    var mappedCountrys = $.map(json.countrys, function(item) {
                        return new Location(item, item.subs)
                    });
                    ...
                    $('.preloader').remove();
                    $('.p02 ul.lnk a').click(function(e) {
                        $('.p02 ul.lnk a').removeClass("selected");
                        $(this).addClass("selected");
                    });
                    $(".p02 ul a:contains('Bayer Global')").trigger("click");
                }
            });
        }
    ...
    var SitesListModel = function() {
        ...
        //functions	
        self.throttledValue = ko.computed(self.searchText).extend({
            throttle: 400
        });
        ...
        self.siteSearch = function() {
            ...
            /*loading indicator*/
            $('.loading.resultcounter, .loading.results').css({
