            ...
            <div class="line">
              <section class="unit size2of3">
                  ...
                  <h2 class="colhead">ข่าว</h2>
					<?php
			  	include "../config/connect.php";
				$sql="select * from tb_press_th WHERE public_press=1 ORDER BY news_date DESC LIMIT 0 , 3 ";
            ...
            <div class="selects bluebg">
              <label class="whitelabel" for="searchfield2">Search</label>
              	<form action="search_content.php" method="post" >
              		<input type="search" placeholder="Enter your search term" name="suchfeld2" id="searchfield2" autocomplete="off"/><button type="button" class="btn searchbtn">Go</button>
              	</form>
...
<!--            <div class="selects greenbg">
          ...
          <aside class="unit size-col-a margi">
            ...
            <div class="margiblock">
				...
				<hr />
                <div class="mimg"><a href="http://www.annualreport2015.bayer.com" target="_blank"><img src="/img/upload/source/RIGHT Menu/button_innopk.png" alt="Bayer AG Financial News Conference: Full Year 2014 Results" width="150" height="84" /></a></div>
                <ul class="mlnk">
