<?php 
	...
	if($call_arti_calldate==''){
		$sql_calldate="SELECT `modify_article` FROM `tb_article_th` ORDER BY `tb_article_th`.`modify_article` DESC ";
	}else{
		$sql_calldate="SELECT `modify_article` FROM `tb_article_th` WHERE menu_article='$call_arti_calldate'";
	}
