<?php
	...
	$sql="SELECT *  FROM `tb_article_th` WHERE topic_article='ติดต่อ'";
  ...
  <div class="page">
    ...
    <nav class="mobilenav">
      <ul class="nobulls">
        ...
        <li><a href="contact.php" class="mcontact"><?php echo"$topic_article"; ?></a></li>
        <li class="mlang"><a href="<?php echo"../en/contact.php";?>" class="mlang">EN</a></li>
      </ul>
    </nav>
      ...
      <div role="main" class="main">
        <div class="service">
          ...
          <ul class="breadcrumb">
            ...
            <li class="last"><a title="ติดต่อ" href="contact.php"><?php echo"$topic_article"; ?></a></li>            
          </ul>
    ...
    <!-- Support Navigation -->
    <nav class="meta">
      <ul class="nobulls"><li><a href="contact.php"><?php echo"$topic_article"; ?></a></li>
        <li><a href="map.php">แผนที่</a></li>
        <li><a href="sitemap.php">Sitemap</a></li>
        <li><a href="<?php echo"../en/contact.php";?>" class="last">English</a></li>
