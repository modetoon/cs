  ...
  <div class="page">
    ...
    <nav class="mobilenav">
      <ul class="nobulls">
        ...
        <li class="mlang"><a href="<?php echo"../en/contentpage_c.php?ID=$call_arti";?>" class="mlang">EN</a></li>
      </ul>
    </nav>
    ...
    <!--##/nosearch##-->
      <div role="main" class="main">
        <div class="service">
        	<ul class="breadcrumb">
              <li class="last"><a href="/th/index.php">Home</a>
              </li>
             </ul>
    ...
    <nav class="meta">
      <ul class="nobulls">
        ...
        <li><a href="<?php echo"../en/contentpage_c.php?ID=$call_arti";?>" class="last">English</a></li>
