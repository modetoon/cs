  ...
  <div class="page">
    ...
    <nav class="mobilenav">
      <ul class="nobulls">
        ...
        <li class="mlang"><a href="<?php echo"../en/jobs.php?ID=$call_arti";?>" class="mlang">EN</a></li>
      </ul>
    </nav>
    ...
    <nav class="meta">
      <ul class="nobulls">
        ...
        <li><a href="<?php echo"../en/jobs.php?ID=$call_arti";?>" class="last">English</a></li>
