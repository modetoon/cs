...
<!--    <nav class="mobilenav">
    ...
    <form action="admin_content_add2.php" method="post" enctype="multipart/form-data" name="form1">
      <!-- ============================== Fieldset 1 ============================== -->
		  ...
		  <div class="spacer-half"></div>
            ...
            <label class="control-label" id="firstnameLabel" for="vorname">Choose, if need add to sub topic :</label>
            	<div class="controls">
