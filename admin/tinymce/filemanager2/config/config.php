...
$upload_dir = '/img/resume/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../img/resume/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../img/resume/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
