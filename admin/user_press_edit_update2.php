...
170, 100);
	...
	if ($upload_path==""){	
	$sql21="UPDATE tb_press_backup set press_type='$press_type', topline='$topline', headerline='$headerline', news_date='$press_date', show_type='$show_type', show_type='$show_type', press_content='$content_article', mod_date='$ndate' where id_press='$id_edit' ";   
	$result21=mysql_db_query($dbname,$sql21) or die(mysql_error());
	$sql22="UPDATE tb_press_th_backup set press_type='$press_type', topline='$topline_th', headerline='$headerline_th', news_date='$press_date', show_type='$show_type', press_content='$content_article_th', mod_date='$ndate' where id_press='$id_edit' ";  
	$result22=mysql_db_query($dbname,$sql22) or die(mysql_error());
	if ($approve==1){	
	$sql31="UPDATE tb_press set press_type='$press_type', topline='$topline', headerline='$headerline', news_date='$press_date', show_type='$show_type', show_type='$show_type', press_content='$content_article', mod_date='$ndate' where id_press='$id_edit' ";   
	$result31=mysql_db_query($dbname,$sql31) or die(mysql_error());
	$sql32="UPDATE tb_press_th set press_type='$press_type', topline='$topline_th', headerline='$headerline_th', news_date='$press_date', show_type='$show_type', press_content='$content_article_th', mod_date='$ndate' where id_press='$id_edit' ";  
	$result32=mysql_db_query($dbname,$sql32) or die(mysql_error());
	}
	}else{
	$sql21="UPDATE tb_press_backup set press_type='$press_type', topline='$topline', headerline='$headerline', news_date='$press_date', show_type='$show_type', press_pic='$upload_path', press_content='$content_article', mod_date='$ndate' where id_press='$id_edit' ";   
	$result21=mysql_db_query($dbname,$sql21) or die(mysql_error());
	$sql22="UPDATE tb_press_th_backup set press_type='$press_type', topline='$topline_th', headerline='$headerline_th', news_date='$press_date', show_type='$show_type', press_pic='$upload_path', press_content='$content_article_th', mod_date='$ndate' where id_press='$id_edit' ";  
	$result22=mysql_db_query($dbname,$sql22) or die(mysql_error());
	if ($approve==1){	
	$sql31="UPDATE tb_press set press_type='$press_type', topline='$topline', headerline='$headerline', news_date='$press_date', show_type='$show_type', press_pic='$upload_path', press_content='$content_article', mod_date='$ndate' where id_press='$id_edit' ";   
	$result31=mysql_db_query($dbname,$sql31) or die(mysql_error());
	$sql32="UPDATE tb_press_th set press_type='$press_type', topline='$topline_th', headerline='$headerline_th', news_date='$press_date', show_type='$show_type', press_pic='$upload_path', press_content='$content_article_th', mod_date='$ndate' where id_press='$id_edit' ";  
	$result32=mysql_db_query($dbname,$sql32) or die(mysql_error());
	}
	}
	...
	if ($approve==1){		
	$sql21="INSERT INTO `tb_press` (`id_press` ,`press_type` ,`topline` ,`headerline` ,`news_date` ,`show_type` ,`press_pic` ,`press_content` ,`view_count` ,`upload_date` ,`mod_date` ,`public_press`)VALUES (NULL, '$press_type', '$topline', '$headerline', '$press_date', '$show_type', '$upload_path', '$content_article', '0', '$ndate', '$ndate', '0'); ";   
	$result21=mysql_db_query($dbname,$sql21) or die(mysql_error());
	$sql22="INSERT INTO `tb_press_th` (`id_press` ,`press_type` ,`topline` ,`headerline` ,`news_date` ,`show_type` ,`press_pic` ,`press_content` ,`view_count` ,`upload_date` ,`mod_date` ,`public_press`)VALUES (NULL, '$press_type', '$topline_th', '$headerline_th', '$press_date', '$show_type', '$upload_path', '$content_article_th', '0', '$ndate', '$ndate', '0'); ";  
	$result22=mysql_db_query($dbname,$sql22) or die(mysql_error());
	}
	}
	...
	if ($result21){
			...
			echo"<p><span class='txtnormal'>Click <a href='user_press.php'>here</a> for back to Press main page.</span></p>";
	}else{			
