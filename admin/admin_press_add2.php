...
170, 100);
	...
	$sql21="INSERT INTO `tb_press_backup` (`id_press` ,`press_type` ,`topline` ,`headerline` ,`intro_content` ,`news_date` ,`show_type` ,`press_pic` ,`press_content` ,`view_count` ,`upload_date` ,`mod_date` ,`public_press`)VALUES ('$id_edit', '$press_type', '$topline', '$headerline',  '$introtext', '$press_date', '$show_type', '$upload_path', '$content_article', '0', '$ndate', '$ndate', '0');";  
	$result21=mysql_db_query($dbname,$sql21) or die(mysql_error());
	$sql22="INSERT INTO `tb_press_th_backup` (`id_press` ,`press_type` ,`topline` ,`headerline` ,`intro_content` ,`news_date` ,`show_type` ,`press_pic` ,`press_content` ,`view_count` ,`upload_date` ,`mod_date` ,`public_press`)VALUES ('$id_edit', '$press_type', '$topline_th', '$headerline_th',  '$introtext_th', '$press_date', '$show_type', '$upload_path', '$content_article_th', '0', '$ndate', '$ndate', '0');";   
