...
<?php include"header_name.php"; ?>
	...
	$sql21="INSERT INTO `tb_legal` (`id_legal`, `id_article`, `name_menu`, `mod_date`) VALUES (NULL, '$xhide', '$name_menu', '$ndate');";   
	$result21=mysql_db_query($dbname,$sql21) or die(mysql_error());
	
	if ($result21){
		echo"<h3>You have added new Legal Menu successfully.</h3><br />";
		echo"<p><span class='txtnormal'>Click <a href='admin_legal.php'>here</a> for back to Legal Navigation main page.</span></p>";
	}else{
		echo"<p><span style='color:#F00'>You cannot add a Legal Navigation, Please kindly try again or contact your IT team.</span></p><br />";
		echo"<p><span class='txtnormal'>Click <a href='admin_legal.php'>here</a> for back to Legal Navigation main page.</span></p>";
	}
	}else{			
		echo"<p><span style='color:#F00'>You cannot add a Legal Navigation, Please kindly try again or contact your IT team.</span></p><br />";
