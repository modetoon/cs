...
<?php
	...
	$sql11="Select * from tb_article_backup where id_article='$id_edit'";
	...
	$sql12="Select * from tb_article_th_backup where id_article='$id_edit'";
        ...
        <section>             
            <!--##/Main Content##-->
             ...
             <div class="unit size-col-d-admin">
              <h1>Edit Article :: Update Version</h1>
              <div class="form-horizontal">
              
    <form action="admin_content_edit_update2.php" method="post" enctype="multipart/form-data" name="form1">
      <!-- ============================== Fieldset 1 ============================== -->
       ...
       <!--Right Menu--> 
			...
			while($rs8=mysql_fetch_array($result8)) {
				...
				$num2=0;
				echo'<input type="checkbox" id="checkbx" name="checkbx[]" ';		
				while($num2<count($rmenu)) {
					if ($rmenu[$num2]==$id_rmenu8){
						echo 'checked="checked"';
					}
				$num2++;
				}
				echo ' value="'.$id_rmenu8.'"> '.$name_rmenu_backend8.' ';
			}
				?>
                </div>
