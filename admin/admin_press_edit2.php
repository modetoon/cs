...
170, 100);
	...
	if ($upload_path==""){
	$sql21="UPDATE tb_press set press_type='$press_type', topline='$topline', headerline='$headerline', intro_content='$introtext', news_date='$press_date', show_type='$show_type', show_type='$show_type', press_content='$content_article', mod_date='$ndate' where id_press='$id_edit' ";   
	$result21=mysql_db_query($dbname,$sql21) or die(mysql_error());
	$sql22="UPDATE tb_press_th set press_type='$press_type', topline='$topline_th', headerline='$headerline_th', intro_content='$introtext_th', news_date='$press_date', show_type='$show_type', press_content='$content_article_th', mod_date='$ndate' where id_press='$id_edit' ";  
	$result22=mysql_db_query($dbname,$sql22) or die(mysql_error());
	}else{
	$sql21="UPDATE tb_press set press_type='$press_type', topline='$topline', headerline='$headerline', intro_content='$introtext', news_date='$press_date', show_type='$show_type', press_pic='$upload_path', press_content='$content_article', mod_date='$ndate' where id_press='$id_edit' ";   
	$result21=mysql_db_query($dbname,$sql21) or die(mysql_error());
	$sql22="UPDATE tb_press_th set press_type='$press_type', topline='$topline_th', headerline='$headerline_th', intro_content='$introtext_th', news_date='$press_date', show_type='$show_type', press_pic='$upload_path', press_content='$content_article_th', mod_date='$ndate' where id_press='$id_edit' ";  
	$result22=mysql_db_query($dbname,$sql22) or die(mysql_error());
	}
	if ($result21){
