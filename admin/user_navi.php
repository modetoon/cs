...
<?php include"header_name_user.php"; ?>           
	...
	if ($refsh==1)echo '<meta HTTP-EQUIV="REFRESH" content="0; url=user_navi.php?chkpage='.$chkpage.'&perpage='.$perpage.'">';
	...
	if ($chkpage==1 && $count>$nextpage){
		echo '<a href="user_navi.php?chkpage='.$nextpage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-next.gif" border=0 alt=""></a>';
	}else if($chkpage==1 && $count<$nextpage){
	}else if($chkpage>((int)(($count+9)/10))*10-$perpage){
		echo '<a href="user_navi.php?chkpage='.$prepage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-previous.gif" border=0 alt=""></a>';
	}else{
		echo '<a href="user_navi.php?chkpage='.$prepage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-previous.gif" border=0 alt=""></a> <a href="user_navi.php?chkpage='.$nextpage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-next.gif" border=0 alt=""></a>';
	}
	echo '</p></div>';
	///////////////////////////////////////////////
	...
	echo"	
		<table class='table txtR'>
			...
			echo	"<td><a href=\"user_navi_edit.php?id_edit=$id_menu\"> Edit</a></td>";
			echo	"</tr>" ;
			}
				$no++;
			}
    ...
    echo '<option value="user_navi.php?chkpage='.$chkpage.'&perpage=10">10</option>';
    echo '<option value="user_navi.php?chkpage='.$chkpage.'&perpage=20">20</option>';
    echo '<option value="user_navi.php?chkpage='.$chkpage.'&perpage=30">30</option>';
	?>
