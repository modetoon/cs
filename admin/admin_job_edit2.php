...
<!--    <nav class="mobilenav">
	...
	if ($result21){		
		echo"<h3>You have edited a Job&Career successfully.</h3><br />";
		echo"<p><span class='txtnormal'>Click <a href='admin_job.php'>here</a> for back to Job&Career main page.</span></p>";
	}else{			
		echo"<p><span style='color:#F00'>You cannot edit a Job&Career, Please kindly try again or contact your IT team.</span></p><br />";
		echo"<p><span class='txtnormal'>Click <a href='admin_job.php'>here</a> for back to Job&Career main page.</span></p>";
	}
	}else{
    ...
    <div class="spacer"></div>
             ...
             <aside class="unit size-col-a margi">
              <div class="margiblock">
                ...
                <hr>
                <div class="mlnk"><a href="admin_job.php">Add new Job&amp;Career.php</a></div>
              </div>
