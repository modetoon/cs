    ...
    <!--##/Top menu##-->
      <div role="main" class="main">
        ...
        <div class="unit size-col-d-admin">
              <h1>Press :: Add Press</h1>
          <div class="form-horizontal">
              
    <form action="admin_press_add2.php" method="post" enctype="multipart/form-data" name="form1" onSubmit="return clickupload();">
      <!-- ============================== Fieldset 1 ============================== -->
        ...
        <div class="spacer"></div>
              <div class="generate-ui-tab">
               ...
               <div class="supertab defaulttab" id="EEFA-1">
            	  ...
            	  <div class="controls">
      		<input type="text" id="anredeLabel" name="topline" class="input-large" placeholder="Please insert English topic at here." required />
                  </div>
  				  </div>
      		...
      		<label class="control-label" id="anredeLabel" for="anrede">Input Header :</label>
            	  <div class="controls">
			<input name="headerline" type="text" class="input-large">
				  </div>
            	  </div>
      		...
      		<label class="control-label" id="anredeLabel" for="anrede">Input Intro Text :</label>
            	  <div class="controls">
			<input name="introtext" type="text" class="input-large">
				  </div>
            	  </div>
    	...
    	<div id="1" class="control-group">
   		<textarea name="content_article" id="content_article" style="width:100%"></textarea>
      		...
      		<label class="control-label" id="anredeLabel" for="anrede">Input Thai Topic :</label>
            	<div class="controls">
      		<input type="text" id="topline_th" name="topline_th" class="input-large" placeholder="Please insert Thai topic at here."/>
                </div>
  				</div>
      		...
      		<label class="control-label" id="anredeLabel" for="anrede">Input Header :</label>
            	<div class="controls">
            <input name="headerline_th" type="text" value="" class="input-large">
            	</div>
                </div>
      		...
      		<label class="control-label" id="anredeLabel" for="anrede">Input Intro Text :</label>
            	  <div class="controls">
			<input name="introtext_th" type="text" class="input-large">
				  </div>
            	  </div>  
   		...
   		<textarea name="content_article_th" id="content_article2" style="width:100%"></textarea>
            ...
            <div class="controls">
      			<input id="inputField" name="press_date" type="text" class="input-large" value="">
            </div>
  			</div>
                  
            <!--<div class="control-group">
      		<label class="control-label" id="anredeLabel" for="anrede">Choose type of news :</label>
            <div class="controls">
      		<input name="press_type" type="radio" value="1"> Country news <input name="press_type" type="radio" value="2"> Global news
            </div>
  			</div>-->
            ...
            <div class="control-group">
      		<label class="control-label" id="anredeLabel" for="anrede">Select type of news :</label>
            	<div class="controls">
      		<input name="show_type" type="radio" value="1"> Text only &nbsp;&nbsp;<input name="show_type" type="radio" value="2"> Both of text and image
                </div>
  			</div>
        ...
        <div class="controls">
                ...
                <label for="vorname"><span style='color:#F00'>**Resolution request: Width 170px, Height 100px</span></label>
        </div>
  		</div>
