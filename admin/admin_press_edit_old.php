...
<?php
	...
	$sql2="select * from tb_press_th where id_press='$id_edit'";
...
<!--    <nav class="mobilenav">
    ...
    <form action="admin_press_edit_old2.php" method="post" enctype="multipart/form-data" name="form1" onSubmit="return clickupload();">
      <!-- ============================== Fieldset 1 ============================== -->
      ...
      <!-- ============================== Fieldset 3 end ============================== -->
        ...
        <div class="buttons">
      	<input name="showweb" type="checkbox" value="1" <?php if($public_press==1)echo "checked"; ?>> Please click check box, If you want to show this press on website</div>
      	<div class="buttons">
