...
<?php include"header_name.php"; ?>
	...
	if ($chkpage==1 && $count>$nextpage){
		echo '<a href="admin_press.php?chkpage='.$nextpage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-next.gif" border=0 alt=""></a>';
	}else if($chkpage==1 && $count<$nextpage){
	}else if($chkpage>((int)(($count+9)/10))*10-$perpage){
		echo '<a href="admin_press.php?chkpage='.$prepage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-previous.gif" border=0 alt=""></a>';
	}else{
		echo '<a href="admin_press.php?chkpage='.$prepage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-previous.gif" border=0 alt=""></a> <a href="admin_press.php?chkpage='.$nextpage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-next.gif" border=0 alt=""></a>';
	}
	...
	echo"			
		<table class='table txtR'>
			...
			echo"	<tr>                  
					...
					<td><a href=\"admin_press_edit_update.php?id_edit=$id_menu2\"> Edit</a></td>
					<td>";
					if ($oldedit==true){
					echo "<a href=\"admin_press_edit_old.php?id_edit=$id_menu2\"> Edit</a>";
					}else{
					echo	"None";
					}
					echo "</td>";
			if ($public_press==0){
				echo	"<td>Not Publish</td>";
			}else{
				echo	"<td>Published</td>";
			}
			echo	"<td><a href=\"admin_press_delete.php?id_del=$id_menu2\"   onclick=\" return confirm ('Click OK if you want to remove $name_menu2 from you data. ')\"  > Remove</a>
					</tr>" ;
			}
				$no++;
			}//////////add for page
    ...
    echo '<option value="admin_press.php?chkpage='.$chkpage.'&perpage=10">10</option>';
    echo '<option value="admin_press.php?chkpage='.$chkpage.'&perpage=20">20</option>';
    echo '<option value="admin_press.php?chkpage='.$chkpage.'&perpage=30">30</option>';
	?>
