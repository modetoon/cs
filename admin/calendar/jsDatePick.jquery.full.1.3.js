...
/*
	...
	Since some of the elements inside the CSS have  background:url(calendar/img/someimage.png);
	...
	else - you HAVE to look and replace each background:url(calendar/img/someimage.png); to the new path you desire.
	...
	Thank you!
*/
g_jsDatePickImagePath = "calendar/img/";
...
JsDatePick.prototype.setConfiguration = function(aConf){
	...
	this.oConfiguration.imgPath			= (g_jsDatePickImagePath.length != null) ? g_jsDatePickImagePath : "calendar/img/";
