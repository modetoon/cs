...
<?php
	...
	if ($refsh==1)echo '<meta HTTP-EQUIV="REFRESH" content="0; url=admin_content.php?chkpage='.$chkpage.'&perpage='.$perpage.'">';
?>
	...
	if ($chkpage==1 && $count>$nextpage){
		echo '<a href="admin_content.php?chkpage='.$nextpage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-next.gif" border=0 alt=""></a>';
	}else if($chkpage==1 && $count<$nextpage){
	}else if($chkpage>((int)(($count+9)/10))*10-$perpage){
		echo '<a href="admin_content.php?chkpage='.$prepage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-previous.gif" border=0 alt=""></a>';
	}else{
		echo '<a href="admin_content.php?chkpage='.$prepage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-previous.gif" border=0 alt=""></a> <a href="admin_content.php?chkpage='.$nextpage.'&perpage='.$perpage.'"><img class="viewnavicon" src="../img/nav-next.gif" border=0 alt=""></a>';
	}
	...
	<table class='table txtR'>
				...
				<tr class='borderblue'>
					...
					<td >Edit Update Version</td>
					<td >Edit Approved Version**</td>
					<td >Remove</td>
                  </tr>";
			...
			echo"
					...
					<td >$m_name_menu</td>
					<td><a href=\"admin_content_edit_update.php?id_edit=$id_article\"> Edit</a></td>
					<td>
					";
					if ($oldedit==true){
			echo	"<a href=\"admin_content_edit_old.php?id_edit=$id_article\"> Edit</a>";
					}else{
			echo	"None";
					}
			echo "</td>
					<td><a href=\"admin_content_delete.php?id_del=$id_article\"   onclick=\" return confirm ('Click OK if you want to delete $topic_article from you data. ')\"  >Remove</a></td>
					</tr>" ;
			}
					$no++;
			}//////////add for page
	...
	?>			
    			...
    			<div class="spacer"></div>
                <p>**This version is showing on website.</p>
				<div class="spacer"></div>
                <div class="spacer"><p>Show per page <select id="selectbox" name="" onChange="javascript:location.href = this.value;">
     <?php
	 echo '<option value="" selected>Select</option>';
    echo '<option value="admin_content.php?chkpage='.$chkpage.'&perpage=10">10</option>';
    echo '<option value="admin_content.php?chkpage='.$chkpage.'&perpage=20">20</option>';
    echo '<option value="admin_content.php?chkpage='.$chkpage.'&perpage=30">30</option>';
	?>
