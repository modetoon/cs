...
<!--Version 4.0.2-->
<title>Standard Content<?php //echo "$topic_article";?> - Bayer</title>
  ...
  <div class="page">
    ...
    <nav role="navigation" class="navigation">
      <ul id="mega-menu" class="megamenu">
        ...
        <li class="n2">
          <a class="haschild selected" href="crp-content.php">Business Operations</a>
          <ul class="newsub">
            <li class="megaTsrBx">
        ...
        <li class="n2">
          <a class="haschild" href="crp-calendar-list.php">Crop Calendar</a>
          <ul class="newsub">
            <li class="megaTsrBx">
      ...
      <div role="main" class="main">
        ...
        <section>
            ...
            <nav id="lefthand" class="unit size-col-a lfthnd">
              ...
              <li class="selected"><a href="crp-content.php" class="selected"> Crop Protections</a></li>
              <li><a href="crp-content.php"> Seeds</a></li>
              <li><a href="crp-content.php"> Environmental Science</a></li>         
            ...
            <div class="unit size-col-d">
              ...
              <div class="topline">Business Operations</div>
              <h1>Crop Protections</h1>

              <div class="media float">
                <div class="bd plntxt">
                  <p>The Crop Protection business offers a broad portfolio of products to farmers with a focus on rice, vegetables and fruit corps. Tiller<sup>&reg;</sup>,Ricestar<sup>&reg;</sup> and Whip<sup>&reg;</sup> are leading herbicides for control of grasses and other weeds in rice. Whereas Ronstar<sup>&reg;</sup> is leading herbicide for control weeds in DDSR (Dry Direct Seed Rice). Solutions for vegetables and fruit corps via new innovative of the fungicide Luna<sup>&reg;</sup> Sensation and include rice fungicide Luna<sup>&reg;</sup>Experience and Antracol <sup>&reg;</sup> and the insecticides Provado<sup>&reg;</sup>and  Folitec<sup>&reg;</sup>.</p>

                  <div class="spacer">&nbsp;</div>
                  
                  <p>Bayer CropScience is committed to consistently introduce new and innovative solutions for farmers in Thailand and to support them with technical expertise.  BELT<sup>&reg;</sup> Expert is a new generation insecticide for the control of leaf folder and stem borer that has recently will be launching into the market. At the same time, Alion<sup>&reg;</sup> is new herbicide product for long lasting (3-6 months) control weeds in oil palm and para rubber. The Bayer Much More Rice (BMMR) project has been launched by  Antracol <sup>&reg;</sup> 2 times and Luna<sup>&reg;</sup> Experience 2 times and successfully introduced for controlling fungus diseases in rice and included Alanto<sup>&reg;</sup> for control thrips and BELT<sup>&reg;</sup> Expert for leaf folder and stem borer in rice. Meanwhile, Basta<sup>&reg;</sup> has been successfully introduced for rid grassy weed and broad leaves weed in fruit and rice bund and use for against weedy rice – an increasing problem in Thai rice farming.</p>
                </div>
              </div>
