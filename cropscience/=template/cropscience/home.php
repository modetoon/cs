      ...
      <section>
          ...
          <div class="unit size-col-d">
                ...
                <div class="line">
                    ...
                    <article class="media">
                      ...
                      <div class="bd plntxt">
                        <div>
                          ...
                          <p>A new Bayer initiative is helping Brazilian farmers cope with a recent incursion of crop-threatening caterpillars. It involves ­everything from basic monitoring and training to a networked database spanning the country’s agricultural landscape. </p>
                          <a class="more" href="crp-content.php">more</a>
                        </div>
                      </div>
                    </article>
                  </div>
                  ...
                  <div class="unit size-col-a">
                    <h2 class="colhead">Social Responsibility</h2>
                      <article class="media">
                      <div class="img"><a href="crp-content.php"><img src="../img/upload/source/About Bayer/Overview/csr_small.jpg" alt="" height="100" width="170"></a></div>
                      <div class="bd plntxt">
                        <div>
                          <h3 class="hdln"><a href="crp-content.php">With our core business, we have a major impact on societal development.</a></h3>
                          <p>At the same time, we depend on intact social framework conditions and an innovation-friendly business environment.</p>
                          <a class="more" href="crp-content.php">more</a>
                        </div>
                      </div>
                      </article>
                    ...
                    <h2 class="colhead">Tomatoes for the global market</h2>
                      ...
                      <div class="bd plntxt">
                        <div>
                          ...
                          <p>Tomatoes come in all shapes and sizes. They can grow in greenhouses or outdoors and each method of cultivation has its own characteristics.</p>
                          <a class="more" href="crp-content.php">more</a>
                        </div>
                      </div>
                      </article>
