...
<!--Version 4.0.2-->
<title>Product-Details <?php //echo "$topic_article";?> - Bayer</title>
            ...
            <div class="unit size-col-d">
              ...
              <div class="media">
                  <figure class="img standardwidth-prod">
                    <img alt="Luna Experience" src="../img/content/Luna-Experience-BT.jpg" title="Luna Experience">
                    <img alt="Luna Experience" src="../img/content/Luna-Experience-500-ml.gif" title="Luna Experience" class="prod-package">
                  </figure>
