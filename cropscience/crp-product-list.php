...
<!--Version 4.0.2-->
<title>Product-list <?php //echo "$topic_article";?> - Bayer</title>
  ...
  <div class="page">
    ...
    <nav role="navigation" class="navigation">
      <ul id="mega-menu" class="megamenu">
        ...
        <li class="n2">
          <a class="haschild selected" href="crp-product-list.php">Products</a>
          <ul class="newsub">
            <li class="megaTsrBx">
      ...
      <div role="main" class="main">
        ...
        <section>
              ...
              <div id="slider" class="flexslider">
                ...
                <?php 	//include "../config/connect.php";
                  ...
                  <li class="flex-active-slide">
                      ...
                      <img alt="" src="../img/stage/stage800x253_nachhaltigkeit.jpg">
                  </li>
            ...
            <nav id="lefthand" class="unit size-col-a lfthnd">
              ...
              <li class="selected"><a class="selected" href="crp-product-list.php">Overview</a></li>
              <li class="haschildren"><a href="crp-product-details.php"> Fungicides</a>
                  <ul>
                    <li><a class="sf-with-ul" href="crp-product-details.php">Luna Experience</a></li>
                    <li><a href="crp-product-details.php">Luna Sensation</a></li>
                    <li><a href="crp-product-details.php">Antracol</a></li>
                    <li><a href="crp-product-details.php">Nativo 75 WG</a></li>
                    <li><a href="crp-product-details.php">Profiler</a></li>
