...
INSERT INTO `content` (`ContentID`, `MenuID`, `TemplateID`, `ProductID`, `CalendarID`, `SliderID`, `ContentNameEN`, `ContentNameTH`, `PageTitleEN`, `PageTitleTH`, `PageHeadlineEN`, `PageHeadlineTH`, `ContentEN`, `ContentTH`, `MetaKeywordEN`, `MetaKeywordTH`, `MetaDescriptionEN`, `MetaDescriptionTH`, `Slug`, `Url`, `ShowLeftMenu`, `Status`, `CreatedDate`, `CreatedBy`, `UpdatedDate`, `UpdatedBy`) VALUES
	...
	(25, 3, 4, 0, 0, 3, 'Crop Calendar', 'Crop Calendar', 'Crop Calendar', 'Crop Calendar', 'Crop Calendar', 'Crop Calendar', '<p>(Sample Text) Crop Science, a division of Bayer, plant fungicides provide outstanding control of a broad spectrum of crop diseases, leading to healthier plants and higher yields. Our products offer a wide variety of fungicidal benefits, with multiple modes of action that protect crops from leaf surface to plant core. New formulations make our fungicides easier to handle, require lower use rates and provide tankmix compatibility with a wide range of crop protection products.</p>', '<p>(Sample Text) Crop Science, a division of Bayer, plant fungicides provide outstanding control of a broad spectrum of crop diseases, leading to healthier plants and higher yields. Our products offer a wide variety of fungicidal benefits, with multiple modes of action that protect crops from leaf surface to plant core. New formulations make our fungicides easier to handle, require lower use rates and provide tankmix compatibility with a wide range of crop protection products.</p>', 'Crop Calendar', 'Crop Calendar', 'Crop Calendar', 'Crop Calendar', 'crop-calendar', 'cropcalendar_list/crop-calendar', 1, 1, NULL, NULL, NULL, NULL),
...
-- Dumping structure for table cropscience.crop_calendar_sub
CREATE TABLE IF NOT EXISTS `crop_calendar_sub` (
  `SubCalendarID` int(11) NOT NULL AUTO_INCREMENT,
  `CalendarID` int(11) NOT NULL DEFAULT '0',
  `BarTitleName` varchar(255) NOT NULL,
  `BarTagName` varchar(255) NOT NULL,
  `BarColorClass` varchar(255) NOT NULL,
  `BrandImage` varchar(255) NOT NULL,
  `BarMarginLeft` decimal(10,2) NOT NULL,
  `BarWidth` decimal(10,2) NOT NULL,
  `Position` int(11) NOT NULL,
  `Status` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`SubCalendarID`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- Dumping data for table cropscience.crop_calendar_sub: ~4 rows (approximately)
/*!40000 ALTER TABLE `crop_calendar_sub` DISABLE KEYS */;
INSERT INTO `crop_calendar_sub` (`SubCalendarID`, `CalendarID`, `BarTitleName`, `BarTagName`, `BarColorClass`, `BrandImage`, `BarMarginLeft`, `BarWidth`, `Position`, `Status`) VALUES
	(1, 1, 'แมลงปากดูด', '5 กรัมต่อเมล็ด 1 กิโลกรัม', 'percent-blue', 'prd-kao-show.jpg', 0.00, 18.00, 1, 1),
	(2, 1, 'เพลี้ยอ่อน/เพลี้ยจั๊กจั่น/เพลี้ยไฟ', '4 กรัม', 'percent-blue', 'prd-pro-va-do.jpg', 18.00, 25.00, 2, 1),
	(3, 1, 'แมลงหวี่ขาว', '6 กรัม', 'percent-blue', 'prd-pro-va-do.jpg', 18.00, 25.00, 3, 1),
	(4, 1, 'คุมวัชพืชทั่วไป', '120 กรัม ต่อไร่', 'percent-orange', 'prd-seg-kor.jpg', 0.00, 22.00, 4, 1),
	(5, 1, 'เร่งการเจริญเติบโต', '50 ซีซี', 'percent-violet', 'prd-bi-po-lan.jpg', 0.00, 50.00, 5, 1),
	(7, 2, 'adasd', 'sadasd', 'percent-orange', 'prd-pro-va-do1.jpg', 0.00, 20.00, 1, 1),
	(8, 2, 'dfsfsdg', 'dfgdfg', 'percent-violet', 'prd-bi-po-lan1.jpg', 20.00, 60.00, 2, 1);
/*!40000 ALTER TABLE `crop_calendar_sub` ENABLE KEYS */;
...
-- Dumping data for table cropscience.slider: ~3 rows (approximately)
...
INSERT INTO `slider` (`SliderID`, `SliderTopLine`, `SliderHeadLine`, `SliderDetail`, `SliderLink`, `SliderImage`, `ShowHome`, `Status`) VALUES
	...
	(3, 'CropScience', 'Crop Calendar', 'Bayer’s broad product portfolio includes many world-famous brands which have shaped the iconic Bayer brand.', '/cropcalendar_list/crop-calendar', 'stage800x253_innovation.jpg', 1, 1);
