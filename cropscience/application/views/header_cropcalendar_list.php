...
<div class="wrapper">
  <div class="page">
    <header id="header">
      <!--[if lt IE 9]><img src="<?php echo $base_url;?>img/header/naming-area.png" alt="Bayer: Science For A Better Life" class="namingarea"/><![endif]-->
      <!--[if gt IE 8]><!-->
              ...
              <div id="slider" class="flexslider">
                <ul class="slides">
                  ...
                  <li class="flex-active-slide">
                      ...
                      <img alt="" src="<?php echo $base_url;?>img/stage/stage800x253_innovation.jpg">
                  </li>
