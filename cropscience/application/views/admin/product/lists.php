        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 right">
                    <p class="text-right"><button type="button" class="btn btn-success text-right" onclick="window.location.href='<?php echo site_url('admin/product_add');?>';">Add Product</button></p>
                </div>
            </div>
