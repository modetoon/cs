        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 right">
                    <p class="text-right"><button type="button" class="btn btn-success text-right" onclick="window.location.href='<?php echo site_url('admin/slider_add');?>';">Add Slider</button></p>
                </div>
            </div>
                            ...
                            <div class="dataTable_wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="ListTable">
                                    ...
                                    <?php
                                        foreach($result as $r){
                                            echo '<tr>
                                                <td><img src="'. site_url('upload/banner/'.$r->SliderImage).'" width="100%"></td>
                                                <td>'.$r->SliderHeadLine.'</td>
                                                <td>'.$r->SliderLink.'</td>
                                                <td class="center">
                                                    <a href="'.site_url("admin/slider/edit/$r->SliderID").'" class="btn btn-warning btn-xs">Edit</a>&nbsp;
                                                    <a href="'.site_url("admin/slider/delete/$r->SliderID").'" class="btn btn-danger btn-xs">Delete</a>
                                                </td>
                                            </tr>';                                       
                                        }
                                    ?>
