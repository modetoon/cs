        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 right">
                    <p class="text-right"><button type="button" class="btn btn-success text-right" onclick="window.location.href='<?php echo site_url('admin/cropcalendar_add');?>';">Add Cropcalendar</button></p>
                </div>
            </div>
                                        ...
                                        foreach($result as $r){
                                            echo '<tr>
                                                ...
                                                <td class="center">
                                                    ...
                                                    <a href="'.site_url("admin/cropcalendar/delete/$r->CalendarID").'" class="btn btn-danger btn-xs">Delete</a>
                                                </td>
                                            </tr>';                                       
                                        }
                                    ?>
